...
| [0002](adr/0002-all-three-transports-in-1-0-0.md) | WebSocket, HTTP streaming, and long polling all ship in 1.0.0 | Accepted |
| [0003](adr/0003-typed-event-stream-as-delivery-surface.md) | A typed `Stream` is the delivery surface, not listener traits | Accepted |
